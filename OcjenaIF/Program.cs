/*
 * Za unesen prosjek ocjena u brojčanom obliku, ispisati opći uspjeh s riječima.
 */
...
namespace OcjenaIF
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Klasičan način rada
            if (ocjena < 1.0) Console.WriteLine("Neispravan unos, ocjena mora biti u rapsonu 1.0 do 5.0!");
            ...
            if (ocjena > 5) Console.WriteLine("Neispravan unos, ocjena mora biti u rasponu 1.0 do 5.0");

            //Prošireni if...else
            if (ocjena <1.0) Console.WriteLine("Neispravan unos, ocjena mora biti veća od 1.0");
